        ...
        <div class="col">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger fw-bold btn-del" href="controller/controller-contact-del-s1.php?file=<?php echo $data['file']; ?>">Hapus</a>
            ...
            <table class="table bg-white rounded shadow-lg ">
                <tbody>
                    <tr>
                        <td>
                            <form action="controller/controller-contact-add-s1.php" method="post" enctype="multipart/form-data">
